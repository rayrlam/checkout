<?php
namespace App\Http\Controllers\Quotation\Api\V1\RatingFactor;

use App\Http\Controllers\Quotation\Api\V1\RatingFactor\RatingFactorInterface;
use App\Http\Controllers\Quotation\Api\V1\QuoteRepository;
