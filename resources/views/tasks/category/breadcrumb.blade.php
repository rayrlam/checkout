        ...
        <form method="post" action="{{route('tasks.category.breadcrumbs')}}">
            ...
            <div class="bg-white">
                <div class="p-2 md:p-4">
                    ...
                    <div class="mt-3">
                        <label for="separator" class="block mb-2 text-xs font-medium text-gray-900 dark:text-white">Select Category</label>
                        <select id="separator" name="sep" class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            @foreach(['>','/','|','\\','*','@'] as $value)
